                    ...
                    <form action="koneksi.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="radio" class="form-checkinput" name="jk" value="perempuan" <?php if (($row['jk']) === "perempuan") {

                                                                                                            echo "checked";
                                                                                                        } ?>> Perempuan
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-checkinput" name="jk" value="laki-laki" <?php if (($row['jk']) === "lakilaki") {
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea class="formcontrol" name="alamat" id="alamat" cols="53" rows="3" placeholder="Alamat"><?= $row['alamat'] ?></textarea>
                            <div class="form-group mt-3">
